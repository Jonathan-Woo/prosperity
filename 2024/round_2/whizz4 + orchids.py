...
class Trader:
    ...
    def ORCHIDS(self, state: TradingState):
        ...
        print(f"ORCHIDS: Current position is {position}.")
        ...
        if buy_arb_opportunity:
            ...
            lowest_we_would_sell = round(purchase + 1)
        ...
        if sell_arb_opportunity:
            ...
            highest_we_would_buy = round(sale - 1)
        ...
        if not (buy_arb_opportunity or sell_arb_opportunity):
            ...
            position_limit = 100 - position
            highest_we_would_buy = round(sale - 1)
            print(f"highest we'd buy is {highest_we_would_buy}")
            size_per_price = 15
            max_iterations = (position_limit // size_per_price) + 1
            for i in range(1, max_iterations):
                if position_limit > 0:
                    ...
                    print(f"most recent order is {Order('ORCHIDS', highest_we_would_buy - i, order_quantity)}")
    ...
    def run(self, state: TradingState):
        ...
        print(f"conversions this iteration is {conversions}")
